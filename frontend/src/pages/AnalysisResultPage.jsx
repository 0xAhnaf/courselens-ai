...
export default function AnalysisResultPage() {
  ...
  if (analysisStatus === 'failed') return <ErrorState title="Analysis failed" message={analysis?.errorMessage || 'The AI provider could not complete this assessment.'} onRetry={load} />
